...
public class BoardGenerator : MonoBehaviour
{
   ...
   board[x, y] = new ChessPiece(PieceType.None, 
PieceColor.None);
            }
        }

        // Place white pieces (bottom of the board)
        board[0, 0] = new ChessPiece(PieceType.Rook, 
PieceColor.White);
        board[0, 1] = new ChessPiece(PieceType.Knight, 
PieceColor.White);
        board[0, 2] = new ChessPiece(PieceType.Bishop, 
PieceColor.White);
        board[0, 3] = new ChessPiece(PieceType.Queen, 
PieceColor.White);
        board[0, 4] = new ChessPiece(PieceType.King, 
PieceColor.White);
        board[0, 5] = new ChessPiece(PieceType.Bishop, 
PieceColor.White);
        board[0, 6] = new ChessPiece(PieceType.Knight, 
PieceColor.White);
        board[0, 7] = new ChessPiece(PieceType.Rook, 
PieceColor.White);

        for (int y = 0; y < BoardSize; y++) {
            board[1, y] = new ChessPiece(PieceType.Pawn, 
PieceColor.White);
        }
